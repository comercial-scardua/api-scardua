...
import type {
  AdicionarEpiCargoData,
  AtualizarCargoEpiData,
  AtualizarColaboradorEpiData,
  AtualizarEpiData,
  CriarCargoEpiData,
  CriarEpiData,
  CriarMovimentacaoEpiData,
  CriarMovimentacaoEstoqueData,
  CriarTransferenciaEpiData,
  RegistrarEntregaData,
} from '../../../../domain/epi/application/repositories/epi-repository'
...
export class PrismaEpiRepository implements EpiRepository {
  ...
  async createEpi(data: CriarEpiData, empresaId?: number) {
  ...
  updateEpi(id: number, data: AtualizarEpiData) {
  ...
  createCargo(data: CriarCargoEpiData) {
    return this.prisma.epi_cargos.create({ data })
  }

  updateCargo(id: number, data: AtualizarCargoEpiData) {
  ...
  async createCargoEpiLink(data: AdicionarEpiCargoData & { cargo_id: number }) {
  ...
  async updateColaboradorEpi(id: number, data: AtualizarColaboradorEpiData) {
  ...
  async createMovimentacaoHistorica(data: RegistrarEntregaData) {
  ...
  async createMovimentacao(data: CriarMovimentacaoEpiData) {
  ...
  async createEstoqueMovimentacao(data: CriarMovimentacaoEstoqueData) {
    const tipoUpper = data.tipo.toUpperCase()
  ...
  async createTransferencia(data: CriarTransferenciaEpiData) {
