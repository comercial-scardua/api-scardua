...
import {
  ...
  type EmpresasRepository,
  type FindAllEmpresasFilters,
  type ListaEmpresasResult,
  type UpdateEmpresaData,
} from '../../../../domain/empresas/application/repositories/empresas-repository'
...
export class PrismaEmpresasRepository implements EmpresasRepository {
  ...
  async findAll({
    ...
    page = 1,
    limit = 10,
  }: FindAllEmpresasFilters): Promise<ListaEmpresasResult> {
    const where = {
  ...
  create(data: CreateEmpresaData, criadoPorId: string) {
