...
import type { ContratoComArquivos, ContratosRepository } from '../repositories/contratos.repository';
import { ContratoNaoEncontradoError } from './errors/contrato-nao-encontrado.error';

type BuscarContratoResult = Either<ContratoNaoEncontradoError, { contrato: ContratoComArquivos }>;
