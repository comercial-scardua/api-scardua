...
export class PrecificadorController {
  ...
  @HttpCode(200)
  @RequirePermission('precificador', 'access')
  @ApiOperation({ summary: 'Buscar por fornecedor (empresaNome no histórico de precificações)' })
  ...
  @ApiOperation({ summary: 'Salvar precificação (cria registro em precificador_historico)' })
  ...
  @HttpCode(200)
  @RequirePermission('precificador', 'edit')
  @ApiOperation({ summary: 'Atualizar preços de produtos (array de { produtoId, preco })' })
  ...
  @HttpCode(200)
  @RequirePermission('precificador', 'edit')
  @ApiOperation({ summary: 'Atualizar preços em lote maior (mesma lógica, sem limite de itens)' })
