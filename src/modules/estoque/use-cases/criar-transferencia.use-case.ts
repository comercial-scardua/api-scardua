...
export class CriarTransferenciaUseCase {
  ...
  async execute(dto: CriarTransferenciaDto, userId: string): Promise<CriarTransferenciaResult> {
    ...
    const saldoOrigem = await this.repo.saldoProdutoNaFilial(dto.produtoId, dto.empresaOrigemId);
