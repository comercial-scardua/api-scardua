...
export class PrismaManuaisRepository implements ManuaisRepository {
  ...
  async create(data: CriarManualDto, usuarioNome: string): Promise<ManualCompleto> {
  ...
  async update(id: number, data: AtualizarManualDto): Promise<ManualCompleto> {
  ...
  async removerArquivo(manualId: number, arquivoId: number): Promise<manual_arquivos | null> {
