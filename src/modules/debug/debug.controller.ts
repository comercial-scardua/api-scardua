...
export class DebugUtilsController {
  ...
  @HttpCode(200)
  @RequirePermission('debug', 'access')
  @ApiOperation({ summary: 'Debug do formato dos NCMs — primeiros 5 registros completos' })
  ...
  @HttpCode(200)
  @RequirePermission('debug', 'access')
  @ApiOperation({ summary: 'Debug dos usuários — contagens por role sem dados sensíveis' })
  async debugUsuarios() {
