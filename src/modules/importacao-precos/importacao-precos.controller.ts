...
export class ImportacaoPrecosController {
  ...
  @ApiOperation({
    summary: 'Importar preços (upsert em massa no modelo de produtos)',
  })
  ...
  @ApiOperation({
    summary: 'Exportar preços dos produtos (filtros: categoria, grupo, marca)',
  })
  ...
  @ApiOperation({
    summary:
      'Listar grupos distintos dos produtos (campo não disponível no modelo atual)',
  })
  grupos() {
  ...
  @ApiOperation({
    summary:
      'Listar marcas distintas dos produtos (campo não disponível no modelo atual)',
  })
  marcas() {
