...
export class IncluirPrecoVendaDto extends createZodDto(
  IncluirPrecoVendaSchema,
) {}
...
export class ImportarPrecoVendaDto extends createZodDto(
  ImportarPrecoVendaSchema,
) {}
