...
export class IncluirTabelaPrecoDto extends createZodDto(IncluirTabelaPrecoSchema) {}
...
export class AtualizarTabelaPrecoDto extends createZodDto(AtualizarTabelaPrecoSchema) {}
...
export class ImportarTabelaPrecoDto extends createZodDto(ImportarTabelaPrecoSchema) {}
