...
export const AtualizarColaboradorSchema = CriarColaboradorSchema.partial()

export type CreateColaboradorData = z.infer<typeof CriarColaboradorSchema>
export type UpdateColaboradorData = z.infer<typeof AtualizarColaboradorSchema>
